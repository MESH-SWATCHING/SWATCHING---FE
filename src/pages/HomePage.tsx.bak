        ...
        <div className="flex h-full items-center px-5">
          <div className="relative h-16 w-[220px] overflow-hidden">
            <img
              src={swatchingLogo}
              alt="Swatching"
              className="absolute left-1/2 top-1/2 size-[220px] max-w-none -translate-x-1/2 -translate-y-1/2 object-contain brightness-105 contrast-[500%]"
            />
          </div>
        ...
        >
          <div className="flex h-[140px] gap-2">
            ...
            <FilterTile
              ...
              onClick={toggleFilter}
              className="h-full w-[45%] rounded-[24px] rounded-bl-[2px] rounded-br-none rounded-tl-none bg-[#c0a27a] text-base text-[#1b1c1a]"
            />
          </div>
          ...
          <div className="flex h-[140px] gap-2">
            <div className="flex w-[55%] flex-col gap-2">
              <FilterTile
                ...
                onClick={toggleFilter}
                className="h-[55%] w-full rounded-[2px] bg-[#6d795a] text-[15px] text-white"
              />
            ...
            <FilterTile
              ...
              onClick={toggleFilter}
              className="h-full w-[45%] rounded-[2px] bg-[#222532] text-base text-white"
            />
          </div>
          ...
          <div className="flex h-[65px] gap-2">
            <FilterTile
              ...
              onClick={toggleFilter}
              className="w-[40%] rounded-[8px] rounded-br-none rounded-tl-none rounded-tr-[2px] bg-[#877054] text-[15px] text-white"
            />
            <FilterTile
              filterId="amekaji"
              label="아메카지"
              ...
              onClick={toggleFilter}
              className="w-[38%] rounded-[2px] bg-[#4e5b76] text-[15px] text-white"
            />
            <FilterTile
              ...
              onClick={toggleFilter}
              className="w-[22%] rounded-[24px] rounded-bl-[2px] rounded-tl-[2px] rounded-tr-none bg-[#b5aba6] text-[13px] text-[#1b1c1a]"
            />
          </div>
        </section>
