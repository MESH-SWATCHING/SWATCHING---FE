...
const P = {
  diagW:  'repeating-linear-gradient(-45deg,transparent 0,transparent 4px,rgba(255,255,255,0.1) 4px,rgba(255,255,255,0.1) 5px)',
  diagB:  'repeating-linear-gradient(-45deg,transparent 0,transparent 4px,rgba(0,0,0,0.07) 4px,rgba(0,0,0,0.07) 5px)',
  diagAW: 'repeating-linear-gradient(45deg,transparent 0,transparent 4px,rgba(255,255,255,0.1) 4px,rgba(255,255,255,0.1) 5px)',
  xhatchB:'repeating-linear-gradient(45deg,transparent 0,transparent 3px,rgba(0,0,0,0.07) 3px,rgba(0,0,0,0.07) 4px),repeating-linear-gradient(-45deg,transparent 0,transparent 3px,rgba(0,0,0,0.07) 3px,rgba(0,0,0,0.07) 4px)',
  xhatchW:'repeating-linear-gradient(45deg,transparent 0,transparent 3px,rgba(255,255,255,0.1) 3px,rgba(255,255,255,0.1) 4px),repeating-linear-gradient(-45deg,transparent 0,transparent 3px,rgba(255,255,255,0.1) 3px,rgba(255,255,255,0.1) 4px)',
  gridW:  'repeating-linear-gradient(0deg,transparent 0,transparent 7px,rgba(255,255,255,0.08) 7px,rgba(255,255,255,0.08) 8px),repeating-linear-gradient(90deg,transparent 0,transparent 7px,rgba(255,255,255,0.08) 7px,rgba(255,255,255,0.08) 8px)',
  vertW:  'repeating-linear-gradient(90deg,transparent 0,transparent 5px,rgba(255,255,255,0.1) 5px,rgba(255,255,255,0.1) 6px)',
  ripstopW:'linear-gradient(45deg,rgba(255,255,255,0.1) 1px,transparent 1px),linear-gradient(-45deg,rgba(255,255,255,0.1) 1px,transparent 1px)',
  plaidB: 'linear-gradient(rgba(72,52,30,0.15) 2px,transparent 2px),linear-gradient(90deg,rgba(72,52,30,0.15) 2px,transparent 2px),linear-gradient(rgba(255,255,255,0.09) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,0.09) 1px,transparent 1px)',
  canvasB:'repeating-linear-gradient(90deg,rgba(58,39,22,0.13) 0,rgba(58,39,22,0.13) 1px,transparent 1px,transparent 4px),repeating-linear-gradient(0deg,rgba(255,255,255,0.07) 0,rgba(255,255,255,0.07) 1px,transparent 1px,transparent 8px)',
} as const;
...
function FilterTile({
  ...
  return (
    ...
    >
      ...
      <span className="filter-tile-label relative z-[1] font-bold">
        {label}
      </span>
    </button>
  );
        ...
        <div className="flex h-full items-center px-5">
          ...
          <div className="pointer-events-auto ml-auto flex items-center gap-4">
            <button
              ...
              className="flex size-10 items-center justify-center rounded-full bg-transparent text-[#47464b] transition-opacity hover:opacity-80"
            >
              <Plus size={28} />
            </button>
            <button
        ...
        >
          <div className="flex h-[140px] gap-2">
            <div className="flex w-[55%] flex-col gap-2">
              ...
              <div className="flex h-1/2 gap-2">
                <FilterTile
                  ...
                  onClick={toggleFilter}
                  style={{ backgroundImage: P.diagB }}
                  className="w-[68%] rounded-[2px] bg-[#DADAD3] text-sm text-[#444444]"
                />
                <FilterTile
                  filterId="street"
                  label="스트릿"
                  ...
                  onClick={toggleFilter}
                  style={{ backgroundImage: P.diagAW }}
            ...
            <FilterTile
              ...
              onClick={toggleFilter}
              style={{ backgroundImage: P.diagW }}
              className="h-full w-[45%] rounded-[24px] rounded-bl-[2px] rounded-br-none rounded-tl-none bg-[#BEA278] text-base text-[#2A1A08]"
            />
          </div>
            ...
            <div className="flex w-[55%] flex-col gap-2">
              ...
              <div className="flex h-[45%] gap-2">
                <FilterTile
                  ...
                  onClick={toggleFilter}
                  style={{
                    backgroundImage: P.plaidB,
                    backgroundSize:
                      "20px 20px, 20px 20px, 5px 5px, 5px 5px",
                  }}
                  className="w-[60%] rounded-[2px] bg-[#C2AC8A] text-sm text-[#2A2010]"
                />
                <FilterTile
                  filterId="feminine"
                  label="페미닌"
                  ...
                  onClick={toggleFilter}
                  className="w-[40%] rounded-[2px] bg-[#CFAAA6] text-sm text-[#2A1010]"
                />
              </div>
            </div>
            <FilterTile
              ...
              onClick={toggleFilter}
              style={{ backgroundImage: P.gridW }}
              className="h-full w-[45%] rounded-[2px] bg-[#252834] text-base text-[#A8B4CC]"
            />
          </div>
          ...
          <div className="flex h-[65px] gap-2">
            <FilterTile
              ...
              onClick={toggleFilter}
              style={{ backgroundImage: P.canvasB }}
              className="w-[40%] rounded-[8px] rounded-br-none rounded-tl-none rounded-tr-[2px] bg-[#8A7256] text-[15px] text-[#F0E8D8]"
            />
            <FilterTile
              filterId="amekaji"
              label="아메카지"
              ...
              onClick={toggleFilter}
              style={{ backgroundImage: P.vertW }}
              className="w-[38%] rounded-[2px] bg-[#4A5978] text-[15px] text-[#D8E0F0]"
            />
            <FilterTile
              ...
              onClick={toggleFilter}
              style={{ backgroundImage: P.diagB }}
              className="w-[22%] rounded-[24px] rounded-bl-[2px] rounded-tl-[2px] rounded-tr-none bg-[#B2ABA4] text-[13px] text-[#2A2A2A]"
            />
          </div>
        </section>
